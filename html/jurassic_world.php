...
<body>
    <header>
       ...
       <!-- <button class="button">Déconnexion</button>!-->
        ...
        <div class="tout">
            <div class="affiche">
                <img src="../images/jurassic_world.jpg" alt="Affiche du film" tittle="Affiche de Jurassic World">       
            </div>
            <div class="droite">
                <div class="rating">
