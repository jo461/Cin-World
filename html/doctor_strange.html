...
<body>
    <header>
       ...
       <!-- <button class="button">Déconnexion</button>!-->
        ...
        <div class="tout">
            <div class="affiche">
                <img src="../images/doctor_strange.jpg" alt="Affiche du film" tittle="Affiche de Doctor Strange">       
            </div>
            <div class="droite">
                <div class="rating">
