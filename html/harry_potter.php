...
<body>
    <header>
       ...
       <!-- <button class="button">Déconnexion</button>!-->
        ...
        <div class="tout">
            <div class="affiche">
                <img src="../images/harry_potter.jpg" alt="Affiche du film" tittle="Affiche de Harry Potter">       
            </div>
            <div class="droite">
                <div class="rating">
