...
<body>
    <header>
       ...
       <!-- <button class="button">Déconnexion</button>!-->
        ...
        <div class="tout">
            <div class="affiche">
                <img src="../images/annabelle.jpg" alt="Affiche du film" tittle="Affiche d'Annabelle">       
            </div>
            <div class="droite">
                <div class="rating">
