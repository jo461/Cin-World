...
<body>
    <header>
       ...
       <!-- <button class="button">Déconnexion</button>!-->
        ...
        <div class="titre">
            <h1>Les Animaux Fantastiques</h1>
        </div>           
        <div class="tout">
            <div class="affiche">
                <img src="../images/animaux_fantastiques.jpg" alt="Affiche du film" tittle="Affiche de Les Animaux Fantastiques">       
            </div>
            <div class="droite">
                <div class="rating">
